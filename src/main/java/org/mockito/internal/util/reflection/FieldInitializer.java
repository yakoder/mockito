...
public class FieldInitializer {
    ...
    /**
     * Represents the strategy used to resolve actual instances to be given to a constructor given
     * the argument types.
     */
    public interface ConstructorArgumentResolver {
         ...
         *
         * <p>Checks on the real argument type or on the correct argument number will happen during
         * the field initialization {@link FieldInitializer#initialize()}. I.e the only
         * responsibility of this method, is to provide instances <strong>if possible</strong>.
         *
