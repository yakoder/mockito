...
public interface OngoingStubbing<T> {
     ...
     * </code></pre>
     *
     * If throwables contain a checked exception then it has to match one of the checked exceptions
     * of method signature.
     *
     ...
     *
     * <p>You can specify <code>throwableTypes</code> to be thrown for consecutive calls. In that
     * case the last throwable determines the behavior of further consecutive calls.
     *
     * <p>If throwable is null then exception will be thrown.
     *
     * <p>See examples in javadoc for {@link Mockito#when}
     ...
     *
     * <p>It allows to create a stub in one line of code. This can be helpful to keep test code
     * clean. For example, some boring stub can be created & stubbed at field initialization in a
     * test:
     *
     * <pre class="code"><code class="java">
